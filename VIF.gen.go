...
func FromVIFToXml(VIF *VIF) (result xmlrpc.Struct) {
	...
	result["uuid"] = VIF.Uuid

	result["allowed_operations"] = VIF.AllowedOperations
	...
	result["device"] = VIF.Device

	result["network"] = VIF.Network

	result["VM"] = VIF.VM

	result["MAC"] = VIF.MAC

	result["MTU"] = strconv.Itoa(VIF.MTU)
	...
	result["currently_attached"] = VIF.CurrentlyAttached

	result["status_code"] = strconv.Itoa(VIF.StatusCode)

	result["status_detail"] = VIF.StatusDetail
	...
	result["qos_algorithm_type"] = VIF.QosAlgorithmType
	...
	result["qos_supported_algorithms"] = VIF.QosSupportedAlgorithms

	result["metrics"] = VIF.Metrics

	result["MAC_autogenerated"] = VIF.MACAutogenerated

	result["locking_mode"] = VIF.LockingMode.String()

	result["ipv4_allowed"] = VIF.Ipv4Allowed

	result["ipv6_allowed"] = VIF.Ipv6Allowed

	result["ipv4_configuration_mode"] = VIF.Ipv4ConfigurationMode.String()

	result["ipv4_addresses"] = VIF.Ipv4Addresses

	result["ipv4_gateway"] = VIF.Ipv4Gateway

	result["ipv6_configuration_mode"] = VIF.Ipv6ConfigurationMode.String()

	result["ipv6_addresses"] = VIF.Ipv6Addresses

	result["ipv6_gateway"] = VIF.Ipv6Gateway
